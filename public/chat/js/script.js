...
$(document).ready(function(){
   		...
   		var socket = io.connect('http://localhost:5000',{// database user_id username
	...
	var cc = "INSERT INTO messages VALUES(?,?,?,?) ";
con.query(cc,['','1','2','ahedd'],function(err,rows,fields)
{
   if(err)
   {
